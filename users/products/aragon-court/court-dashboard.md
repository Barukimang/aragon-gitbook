...
After you successfully verify your email address, click the "x" button in the top corner to close the notification verification window then re-enable your Ethereum account on the main Dashboard page.&#x20;
