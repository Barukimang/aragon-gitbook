...
The metadata of an entity is represented as a [JSON file](https://docs.vocdoni.io/architecture/data-schemes/entity-metadata.html#json-schema) that conforms to a specific schema. This data is typically retrieved using a P2P storage system like IPFS.
...
* [Entity Metadata](https://docs.vocdoni.io/architecture/data-schemes/entity-metadata.html#entity-metadata)
  * [JSON schema](https://docs.vocdoni.io/architecture/data-schemes/entity-metadata.html#json-schema)
    * [Register](https://docs.vocdoni.io/architecture/data-schemes/entity-metadata.html#register)

### JSON schema <a href="#json-schema" id="json-schema"></a>

To fetch the metadata of an entity, client applications are expected to fetch the value of the [ENS Text Record](https://docs.vocdoni.io/architecture/smart-contracts/entity-resolver.html#text-record-storage) `vnd.vocdoni.meta`, which contains a [Content URI](https://docs.vocdoni.io/architecture/protocol/data-origins.html#content-uri).

The [Content URI](https://docs.vocdoni.io/architecture/protocol/data-origins.html#content-uri) is expected to point to a JSON file, conforming to the following schema:
...
* [Set Entity metadata](https://docs.vocdoni.io/architecture/sequence-diagrams.html#set-entity-metadata)
* [Entity subscription](https://docs.vocdoni.io/architecture/sequence-diagrams.html#entity-subscription)
...
As this all happens through [Gateway requests](https://docs.vocdoni.io/architecture/protocol/json-api.html#authentication), `signature` is computed from the stringified JSON of `request`, where its keys are sorted alphabetically.
