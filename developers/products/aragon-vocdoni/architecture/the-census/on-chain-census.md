...
The second case, referred to as an on-chain census, enables the weighted set of eligible voters for a process to be derived from the token holder balances for some ERC-20 Ethereum token. This is possible through the use of [Ethereum Storage Proofs](https://docs.vocdoni.io/architecture/smart-contracts/storage-proofs.html).

### ERC-20 Token Storage Proofs <a href="#erc-20-token-storage-proofs" id="erc-20-token-storage-proofs"></a>
...
### Token Registration <a href="#token-registration" id="token-registration"></a>
...
### Election creation <a href="#election-creation" id="election-creation"></a>
